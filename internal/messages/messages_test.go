...
func TestTask15_AllMessagesEnglishOnly(t *testing.T) {
...
func TestTask15_TerminologyConsistency(t *testing.T) {
...
func TestTask15_FormatConsistency(t *testing.T) {
...
func TestTask15_PlaceholderUsageConsistency(t *testing.T) {
